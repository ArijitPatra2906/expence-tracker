...
function Analitics({ transactions }) {
    ...
    const categories = ["food", "salary", "entertainment", "travel", "emi", "education", "recharge", "medical", "investment", "others"]
            ...
            <div className="row">
                <div className="col-md-4 mt-3">
                    <div className="transactions-count">
                        ...
                        <div className="progress-bars d-flex align-items-center justify-content-around mt-4">
                            <Progress strokeColor="#5dd64f" type="circle" percent={totalIncomeTransactionsPercentage.toFixed(0)} />
                ...
                <div className="col-md-4 mt-3">
                    <div className="transactions-count">
                        ...
                        <div className="progress-bars d-flex align-items-center justify-content-around mt-4">
                            <Progress strokeColor="#5dd64f" type="circle" percent={totalIncomeTurnOverPercentage.toFixed(0)} />
                        ...
                        {categories.map((category) => {
                            ...
                            return (
                                amount > 0 && <div className='category-card'>
                                    <h5>{category}</h5>
                                    <Progress strokeColor="#0b5ad9" percent={(amount / totalIncomeTurnOver) * 100} />
                                </div>
                            )
                        }
                        )}
